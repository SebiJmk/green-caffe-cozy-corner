...
const SiteFooter = () => {
  ...
  return (
    <footer id="footer" className="relative bg-[#0A1A12]">
      {/* ── Map + Directions (flex column, no overlap) ── */}
      <div ref={mapRef} className="flex flex-col">
        <motion.div style={{ opacity: mapOpacity, scale: mapScale }} className="relative w-full h-[45vh] md:h-[65vh] overflow-hidden">
          <iframe
            src={MAP_SRC}
        ...
        {/* Directions button — BELOW map, in normal flow */}
        <div className="flex justify-center mt-4 mb-2 px-6">
          <MagneticWrap strength={0.25}>
            <a
              ...
              data-cursor-hover
              className="group inline-flex items-center gap-3 bg-[#0A1A12]/60 backdrop-blur-xl border border-[#F4F1EA]/15
                rounded-full px-8 py-4 transition-all duration-500
                hover:bg-[#0A1A12]/80 hover:border-[#F4F1EA]/30"
            >
      ...
      {/* ── Concierge Console — gap-8 from map, no negative margin on mobile ── */}
      <div className="relative z-10 mt-8 md:-mt-24 max-w-5xl mx-auto px-4 sm:px-6 md:px-10">
        <Reveal>
          <div className="bg-[#0A1A12]/80 backdrop-blur-2xl border border-[#F4F1EA]/10 rounded-sm p-6 md:p-14 h-auto">
            ...
            <p className="font-sans text-xs tracking-[0.25em] uppercase text-[#F4F1EA]/30 mb-8 md:mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
              <ActionTile label="Reservations & Contact">
                <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                  ...
                  <span className="font-serif text-base sm:text-xl md:text-2xl text-[#F4F1EA]/80 group-hover:text-[#F4F1EA] transition-colors duration-500 break-all">
                    0723 508 244
                  </span>
                </div>
              </ActionTile>
              ...
              <ActionTile label="Join the Community" href="https://www.instagram.com/greencaffe.bucharest">
                <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                  ...
                  <span className="font-serif text-sm sm:text-lg md:text-2xl text-[#F4F1EA]/80 group-hover:text-[#F4F1EA] transition-colors duration-500 break-all">
      ...
      {/* ── Footer Sign-off ── */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-10 pt-16 md:pt-20 pb-14">
        <Reveal>
          <div className="border-t border-[#F4F1EA]/[0.08] mb-10" />
